                ...
                <main>
                    <section className="border-b border-border/60 bg-card">
                        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
                            ...
                            <h1 className="mt-6 max-w-3xl text-4xl leading-[1.08] font-medium tracking-tight text-balance sm:text-5xl lg:text-6xl">
                                La confianza también se construye
                            </h1>
                            <p className="mt-6 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                                Conoce experiencias con Punto Madera y cuéntanos
                                cómo quedó tu proyecto de muebles, puertas,
                                closets o carpintería a medida.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="bg-background py-20 sm:py-28">
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            {reviewStatus && (
                                <Card className="mb-8 border-primary/20 bg-card shadow-none">
                                    ...
                                    {reviews.length > 0 ? (
                                        ...
                                        <Card className="mt-6">
                                            <CardContent className="p-6 text-sm leading-7 text-muted-foreground">
                                                ...
                                                publicadas. Comparte tu
                                                experiencia; después de una
                                ...
                                <Card className="lg:sticky lg:top-28">
                                    <CardHeader>
                                        ...
                                        <p className="text-sm leading-6 text-muted-foreground">
                                            Tu opinión nos ayuda a mejorar y
                                            orienta a otras personas. Las
                                            publicaciones se revisan antes de
